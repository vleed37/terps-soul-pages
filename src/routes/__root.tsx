...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Terps — Infused Pre-Rolls. Flavour First." },
      { name: "description", content: "South African premium infused pre-rolls and Caviar Sticks. Selected cultivars, cured hash and crumble. Flavour first." },
