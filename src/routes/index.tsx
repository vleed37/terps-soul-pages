...
import { INSTAGRAM_HANDLE, INSTAGRAM_URL, SALES_EMAIL } from "@/lib/brand";
        ...
        <div className="mx-auto max-w-[1200px]">
          <ScrollReveal className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-[color:var(--text-secondary)] md:text-lg">
              Terpenes shape the aroma and the flavour of every strain. See what's in each drop and what it
              tastes like.
            </p>
          </ScrollReveal>
          <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              { name: "Limonene", taste: "tastes like citrus", d: "Bright, sharp citrus peel — the zest at the front of the pull." },
              { name: "Myrcene", taste: "tastes like mango", d: "Tropical and sweet, with a soft, round finish." },
              { name: "Pinene", taste: "tastes like pine", d: "Fresh pine needle and crushed herb, clean on the palate." },
            ].map((t, i) => (
              <ScrollReveal
                key={t.name}
                delay={i * 0.08}
                className="rounded-lg border border-[color:var(--border-subtle)] bg-[color:var(--bg-surface)] p-8"
              >
      ...
      <section className="relative overflow-hidden bg-[color:var(--bg-contrast)] px-6 py-32 md:py-40">
        <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-16 md:grid-cols-5">
          <div className="md:col-span-3">
            <ScrollReveal>
              ...
              <p className="mt-8 max-w-xl font-body text-lg leading-relaxed text-[color:var(--text-on-dark)] opacity-80">
                Register your store for box pricing, first look at new drops and marketing support.
              </p>
              <div className="mt-12">
                <a href="/wholesale">
          ...
          <ScrollReveal delay={0.15} className="md:col-span-2">
            <img
              src={stockistImage}
              alt="Terps retail display in a partner store"
              loading="lazy"
